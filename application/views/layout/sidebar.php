    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="<?= base_url() ?>"><img src="<?= base_url(); ?>assets/images/logo/logo.svg" alt="Logo"
                            srcset=""></a>
        ...
        <div class="sidebar-menu">
            ...
            <ul class="menu">
                ...
                <?php if ($this->login_model->isNotLogin()) { ?>
                ...
                <li class="sidebar-item">
                    <a href="<?= base_url("home/penyakit"); ?>" class='sidebar-link'>
                ...
                <li class="sidebar-item ">
                    <a href="<?= base_url("home/gejala"); ?>" class='sidebar-link'>
                        <i class="bi bi-card-list"></i>
                        <span>Gejala</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a href="<?= base_url("penyakit"); ?>" class='sidebar-link'>
                        <i class="bi bi-card-list"></i>
                        <span>Penyakit</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item ">
                    <a href="<?= base_url("gejala"); ?>" class='sidebar-link'>
                        <i class="bi bi-card-list"></i>
                        <span>Gejala</span>
                    </a>
                </li>
